...
class FinancialMetricsService {
    ...
    static getRevenueMetrics(startDate = null, endDate = null) {
    ...
    // @param startDate (optional) is the start date of the date range to get the metrics for
    // @param endDate (optional) is the end date of the date range to get the metrics for
    static getOperationalCosts(startDate = null, endDate = null) {
    ...
    // @param startDate (optional) is the start date of the date range to get the metrics for
    // @param endDate (optional) is the end date of the date range to get the metrics for
    static getProfitMetrics(startDate = null, endDate = null) {
    ...
    static getVehicleMileageMetrics() {
    ...
    static getDetailedFinancialReport(startDate = null, endDate = null) {
        const report = {};
        // Get all the metrics for the report
        report.revenue = this.getRevenueMetrics(startDate, endDate);
        report.operationalCosts = this.getOperationalCosts(startDate, endDate);
        report.profit = this.getProfitMetrics(startDate, endDate);
        report.mileage = this.getVehicleMileageMetrics();
        return report;
    }
    ...
    // @param startDate (optional) is the start date of the date range to get the metrics for
    // @param endDate (optional) is the end date of the date range to get the metrics for
    static getVehicleSpecificMetrics(vehicleId, startDate = null, endDate = null) {
